...
namespace hashed
{
    ...
    const std::uint64_t concatID(const uint64_t value1, const uint64_t value2, const eosio::name label);
    const std::uint64_t concatID(const uint64_t value1, const uint64_t value2);
    const std::uint64_t concatID(const uint64_t value, const eosio::name label);
