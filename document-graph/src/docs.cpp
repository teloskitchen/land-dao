...
namespace hashed
{
   ...
   void docs::updatedoc(const checksum256 & document_hash, ContentGroups &content_groups)
   {
      Document doc(get_self(), document_hash);
      ContentGroups & doc_cg = doc.getContentGroups();
